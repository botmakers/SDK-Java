...
public class SendAuthorizeRequestResponse {
    ...
    @XmlElementRef(name = "URL_Request", namespace = "http://api.todopago.com.ar", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PublicRequestKey", namespace = "http://api.todopago.com.ar", type = JAXBElement.class, required = false)
