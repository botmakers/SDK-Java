...
public class SendAuthorizeRequest {
    ...
    @XmlElementRef(name = "Session", namespace = "http://api.todopago.com.ar", type = JAXBElement.class, required = false)
    protected JAXBElement<String> session;
    @XmlElement(name = "Merchant", required = true)
    protected String merchant;
    @XmlElementRef(name = "URL_OK", namespace = "http://api.todopago.com.ar", type = JAXBElement.class, required = false)
    protected JAXBElement<String> urlok;
    @XmlElementRef(name = "URL_ERROR", namespace = "http://api.todopago.com.ar", type = JAXBElement.class, required = false)
