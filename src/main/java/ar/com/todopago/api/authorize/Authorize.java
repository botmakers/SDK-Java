    ...
    extends Service
{
    ...
    private final static QName AUTHORIZE_QNAME = new QName("http://api.todopago.com.ar", "Authorize");
    ...
    public AuthorizePortType getAuthorizeHttpsSoap11Endpoint() {
        return super.getPort(new QName("http://api.todopago.com.ar", "AuthorizeHttpsSoap11Endpoint"), AuthorizePortType.class);
    }
    ...
    public AuthorizePortType getAuthorizeHttpsSoap11Endpoint(WebServiceFeature... features) {
        return super.getPort(new QName("http://api.todopago.com.ar", "AuthorizeHttpsSoap11Endpoint"), AuthorizePortType.class, features);
    }
    ...
    public AuthorizePortType getAuthorizeHttpSoap11Endpoint() {
        return super.getPort(new QName("http://api.todopago.com.ar", "AuthorizeHttpSoap11Endpoint"), AuthorizePortType.class);
    }
    ...
    public AuthorizePortType getAuthorizeHttpSoap11Endpoint(WebServiceFeature... features) {
        return super.getPort(new QName("http://api.todopago.com.ar", "AuthorizeHttpSoap11Endpoint"), AuthorizePortType.class, features);
    }
